...
{
    public class MadLabTemplate : DungeonTemplate
    {
        ...
        private static readonly DungeonObject web = new DungeonObject
        {
            ObjectType = Web
        };
        ...
        static MadLabTemplate()
        {
            MapTemplate = ReadTemplate(typeof(MadLabTemplate));
        }
