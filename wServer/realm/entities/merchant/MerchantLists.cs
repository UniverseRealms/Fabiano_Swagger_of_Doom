...
namespace wServer.realm.entities
{
    internal class MerchantLists
    {
        ...
        public static Dictionary<int, Tuple<int, CurrencyType>> MerchantPrices = new Dictionary<int, Tuple<int, CurrencyType>>
        {
            ...
            {0xa8f, new Tuple<int, CurrencyType>(TM ? 1 : 1, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa90, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa91, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa92, new Tuple<int, CurrencyType>(TM ? 1 : 1, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa93, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa94, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa95, new Tuple<int, CurrencyType>(TM ? 1 : 1, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa96, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xad3, new Tuple<int, CurrencyType>(TM ? 1 : 1, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            ...
            {0xa55, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa5b, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa65, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xa6b, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xaa8, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xaaf, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xab6, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xae1, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb20, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb22, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb23, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb24, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb25, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb26, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb27, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb28, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb29, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb2a, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb2b, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb2c, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb2d, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xb32, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            ...
            {0xcc7, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xcc8, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            {0xcc9, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)},
            ...
            {0xc8b, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare canine egg
            {0xc8e, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon avian egg
            {0xc8f, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare avian egg
            {0xc92, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon exotic egg
            {0xc93, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare exotic egg
            {0xc96, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon farm egg
            {0xc97, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare farm egg
            {0xc9a, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon woodland egg
            {0xc9b, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare woodland egg
            {0xc9e, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon reptile egg
            {0xc9f, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare reptile egg
            {0xca2, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon insect egg
            {0xca3, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare insect egg
            {0xca6, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon pinguin egg
            {0xca7, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare pinguin egg
            {0xcaa, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon aquatic egg
            {0xcab, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare aquatic egg
            {0xcae, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon spooky egg
            {0xcaf, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare spooky egg
            {0xcb2, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon humanoid egg
            {0xcb3, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare humanoid egg
            {0xcb6, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon ???? egg
            {0xcb7, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //rare ???? egg
            {0xcba, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //uncommon automaton egg
            ...
            {0x70a, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Abyss of demons key
            {0x70b, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Snake pit key
            {0x710, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Tomb of the ancients key
            {0x71f, new Tuple<int, CurrencyType>(TM ? 1 : 1, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Sprite World Key
            {0xc11, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Ocean Trench Key
            {0xc19, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Totem Key
            {0xc23, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Manor Key
            {0xc2e, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Daby's Key
            {0xc2f, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Lab Key
            {0xcce, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Deadwater docks key
        ...
        public static void InitMerchatLists(XmlData data)
        {
            ...
            foreach (KeyValuePair<ushort, Item> item in data.Items.Where(_ => ExcludedCloths.All(i => i != _.Value.ObjectId)))
            {
                ...
                {
                    MerchantPrices.Add(item.Value.ObjectType, new Tuple<int, CurrencyType>(TM ? 1 : 51, TM ? CurrencyType.Fame : CurrencyType.Gold));
                ...
                {
                    MerchantPrices.Add(item.Value.ObjectType, new Tuple<int, CurrencyType>(TM ? 1 : 160, TM ? CurrencyType.Fame : CurrencyType.Gold));
